...
// ============================================================================
// HARDWARE PIN CONFIGURATION (ESP32 WROOM DA 38-Pin)
// ============================================================================
...
// ============================================================================
// Soft Access Point (AP) - Direct Laptop Connection
const char* AP_SSID = "Proximity_Plant_AP";
const char* AP_PASS = "12345678";

// Station (STA) - Facility Wi-Fi Router Connection for Mobile Devices
const char* STA_SSID = "Facility_WiFi";
const char* STA_PASS = "IndustrialPass2026";
...
void evaluateThresholdsAndSetLEDs(float dist) {
  ...
  // Requirement 2: Distance Threshold Logic
  ...
  if (dist < 20.0f) {
    ...
    currentHealthStatus = "CLOSE RANGE (< 20 cm)";
  } else if (dist >= 20.0f && dist <= 35.0f) {
    digitalWrite(GREEN_LED_PIN, LOW);
    digitalWrite(YELLOW_LED_PIN, HIGH);
    digitalWrite(RED_LED_PIN, LOW);
    currentLEDStatus = "YELLOW";
    currentHealthStatus = "MID RANGE (20 cm - 35 cm)";
  } else { // dist > 35.0f
    digitalWrite(GREEN_LED_PIN, LOW);
    digitalWrite(YELLOW_LED_PIN, LOW);
    digitalWrite(RED_LED_PIN, HIGH);
    currentLEDStatus = "RED";
    currentHealthStatus = "FAR RANGE (> 35 cm)";
  }
}
...
void setup() {
  ...
  delay(500);
  Serial.println("\n==============================================");
  Serial.println(" ESP32 Dual-Interface Proximity Monitor ");
  Serial.println("==============================================");
  ...
  if (!LittleFS.begin(true)) {
    Serial.println("[ERROR] LittleFS Mounting Failed! Formatting...");
  } else {
  ...
  // Connect to Local Wi-Fi Router (STA Mode for Mobile Device Access)
  Serial.print("[STA] Connecting to Facility Router SSID: ");
  Serial.println(STA_SSID);
  WiFi.begin(STA_SSID, STA_PASS);

  // 4. Web Dashboard & Server Endpoints Setup (Requirement 4)
  // Serve static HTML file from LittleFS
  ...
  // Serve dynamic telemetry API endpoint for Web UI live updates
